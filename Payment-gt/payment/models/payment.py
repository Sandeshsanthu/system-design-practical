...
from payment.config.database import Base        # ✅ lowercase
from payment.models.enums import PaymentStatus  # ✅


def _now() -> datetime:
    return datetime.now(tz=UTC)  # ✅ replaces deprecated datetime.utcnow
...
class Payment(Base):
    ...
    __table_args__ = (
        ...
        # ✅ idx_order removed — order_id column already has index=True
    )
