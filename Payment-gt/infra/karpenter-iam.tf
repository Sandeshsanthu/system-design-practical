  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = ["arn:aws:eks:${var.aws_region}:149614785419:cluster/${var.cluster_name}"]
      }
    ]
  })
}
...
resource "aws_iam_role_policy_attachment" "karpenter_node_policies" {
  for_each = toset([
    ...
    "arn:aws:iam::aws:policy/AmazonSSMManagedInstanceCore"   # enables SSM session manager on nodes
  ])
...
# EKS access entry for nodes launched by Karpenter
